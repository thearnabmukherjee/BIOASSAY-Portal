...
@Component({
	selector: 'app-view-cfmanalysis',
	templateUrl: './view-cfmanalysis.component.html',
	styleUrls: ['./view-cfmanalysis.component.scss']
})
export class ViewCFMAnalysisComponent implements OnInit, OnChanges
{
